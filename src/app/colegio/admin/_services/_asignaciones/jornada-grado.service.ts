...
@Injectable()
export class JornadaGradoService {
  headers = new Headers({
  ...
  getBussy(): Promise<any> {
    const url = `${this.basePath}/api/bussy/studyingdaysgrades`;
    return this.http.get(url)
      .toPromise()
      .then(response => {
        return response.json();
  ...
  create(form): Promise<any> {
    const url = `${this.basePath}/api/studyingdaysgrades/signedup`;
  ...
  deleteAll(form): Promise<any> {
    const url = `${this.basePath}/api/studyingdaysgrades/signeddown`;
    return this.http.post(url, form)
      .toPromise()
      .then(response => {
        return response.json();
