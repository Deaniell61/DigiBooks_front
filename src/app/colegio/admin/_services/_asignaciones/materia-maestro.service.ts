...
export class MateriaMaestroService {
  ...
  getBussy(): Promise<any> {
    const url = `${this.basePath}/api/bussy/subjectsteachers`;
    return this.http.get(url)
      .toPromise()
      .then(response => {
        return response.json();
  ...
  getMyGrandChilds(id: number): Promise<any> {
    const url = `${this.basePath}/api/subjects/${id}/teachers`;
    return this.http.get(url)
      .toPromise()
      .then(response => {
        return response.json();
  ...
  getMyId(id: number, id2: number): Promise<any> {
    const url = `${this.basePath}/api/grades/${id}/subjects/${id2}`;
  ...
  create(form): Promise<any> {
    const url = `${this.basePath}/api/subjectsteachers/signedup`;
  ...
  deleteAll(form): Promise<any> {
    const url = `${this.basePath}/api/subjectsteachers/signeddown`;
    return this.http.post(url, form)
      .toPromise()
      .then(response => {
        return response.json();
